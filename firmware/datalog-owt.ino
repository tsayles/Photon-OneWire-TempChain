...
void publishData(){
    ...
    delay(1500); // don't publish too many events at once.
...
void publishTemoOW(){
    ...
    for(;moreAddrs;){
        ...
        if(moreAddrs){
            strTemoOW.concat("{");
            strTemoOW.concat(" \"addrROM\": \"");
            strTemoOW.concat(addrROM);
            strTemoOW.concat("\" , ");
            strTemoOW.concat(" \"rawTemp\": \"");
            strTemoOW.concat(rawTemp);
            strTemoOW.concat("\" }");
            Serial.print("TempOW = ");
            Serial.println(strTemoOW);

            Particle.publish("TempOW", strTemoOW);
